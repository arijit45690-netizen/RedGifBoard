        ...
        currentDownloadJob = serviceScope.launch {
            ...
            try {
                val cacheFile = withContext(Dispatchers.IO) {
                    ...
                    if (!file.exists()) {
                        // Optimization: Retrieve the file from Glide's disk cache instead of redownloading.
                        // Since the GIF was just displayed, it's guaranteed to be in the cache.
                        // This eliminates a redundant network request, saving time and bandwidth.
