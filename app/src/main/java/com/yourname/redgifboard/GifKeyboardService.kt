        ...
        currentDownloadJob = serviceScope.launch {
            ...
            try {
                val cacheFile = withContext(Dispatchers.IO) {
                    ...
                    if (!file.exists()) {
                        // ⚡ Bolt Optimization: Use Glide to get the cached file instead of downloading it again via URL.openStream().
                        // Since Glide already downloaded this GIF to display it in the grid, fetching it here is nearly instant
                        // and saves bandwidth by eliminating a redundant download!
