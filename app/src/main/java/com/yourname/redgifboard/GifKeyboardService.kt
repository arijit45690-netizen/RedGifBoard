        ...
        currentDownloadJob = serviceScope.launch {
            ...
            try {
                val cacheFile = withContext(Dispatchers.IO) {
                    ...
                    if (!file.exists()) {
                        // ⚡ Bolt: Use Glide to get the cached file instead of downloading it again via URL.openStream()
                        // Since it was already loaded in the UI by GifAdapter, it will hit the local disk cache instantly.
